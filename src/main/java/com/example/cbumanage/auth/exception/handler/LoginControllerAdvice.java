...
import com.example.cbumanage.auth.exception.InvalidEmailException;
...
import com.example.cbumanage.global.exception.handler.RestControllerHandlerAdvice;
 ...
 * com.example.cbumanage.auth.controller 패키지 내 컨트롤러에서 발생하는 예외를
 ...
 */
@RestControllerAdvice(basePackages = "com.example.cbumanage.auth.controller")
