...
public class LoginService {
    ...
    public LoginResult login(UserLoginRequest request) {
        ...
        return new LoginResult(tokenInfo, user.getUserId(), user.getName(), user.getEmail(), user.getRole().name());
    }

    public record LoginResult(TokenInfo tokenInfo, Long userId, String name, String email, String role) {}
